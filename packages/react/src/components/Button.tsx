...
export function Button({
  ...
  ...rest
    ...
    return(
        <button type='button' {...rest} className={`rounded-Myll_sm text-Myll_sm font-Myll_medium font-Myll_default text-center min-w-[120px] box-border py-0 px-4 flex items-center justify-center gap-2 cursor-pointer disabled:cursor-not-allowed
